...
import de.ait.javalessons.DevelopmentGr42MiApplication;
...
@SpringBootTest(classes = {DevelopmentGr42MiApplication.class, SecurityConfigJDBC.class} , webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
